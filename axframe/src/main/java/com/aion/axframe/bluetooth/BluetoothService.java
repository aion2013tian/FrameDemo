...
package com.aion.axframe.bluetooth;
    ...
    private class AcceptThread extends Thread {
                    ...
                    synchronized (BluetoothService.this) {
                        ...
                        case STATE_CONNECTED:
                            try {
                                ...
                                ALog.e(TAG, "Could not close unwanted socket", e);
                            }
                            break;
                        }
                    }
        ...
        public void cancel() {
            try {
                ...
                ALog.e(TAG, "close() of server failed", e);
            }
        }
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                try {
                    ...
                    ALog.e(TAG, "unable to close() socket during connection failure", e2);
                }
        ...
        public void cancel() {
            try {
                ...
                ALog.e(TAG, "close() of connect socket failed", e);
            }
        }
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket) {
            ...
            try {
                ...
                ALog.e(TAG, "ConnectedThread temp sockets not created", e);
            }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    ALog.e(TAG, "ConnectedThread disconnected", e);
        ...
        public void write(int requestCode, byte[] command, String prefix) {
            try {
            	...
            	curRequestCode = -1;
                ALog.e(TAG, "ConnectedThread write failed.", e);
            }
        }
        ...
        public void cancel() {
            try {
                ...
                ALog.e(TAG, "ConnectedThread cancel socket failed.", e);
            }
        }
    }
}
